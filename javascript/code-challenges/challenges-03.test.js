...
const containsAnd = (arr) => {
  let PATTERN = 'and';
  let filtered = arr.filter(function (str) { return str.includes(PATTERN); });
  return filtered;
  // Solution code here...
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  ...
  let sol=arr.filter((i)=>!forbiddenValues.includes(i));
  return sol;
};
